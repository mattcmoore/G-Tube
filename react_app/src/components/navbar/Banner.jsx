...
import { faBars, faUser, faHome, faFilm, faBook, faHistory, faPlay, faPhotoFilm, faTransgender, faFire, faBagShopping, faMusic, faRadio, faNewspaper, faGamepad, faLightbulb, faPersonDress, faPodcast, faPlusCircle, faTrophy, faFlag, faGear, faQuestionCircle, faMessage, faPlus, faTv, faChildDress, faBaby, faBabyCarriage, faNotesMedical } from '@fortawesome/free-solid-svg-icons';
